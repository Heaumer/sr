...
On modifie le fichier \textit{etc/main.cf}
\begin{verbatim}
...
# mydestination = passerelle, localhost.localdomain, , localhost
...
dans \textit{etc/master.cf} la ligne du service \textit{smtp} ainsi :
\begin{verbatim}
...
\end{verbatim}
Le mot de passe UNIX est alors demandé.
